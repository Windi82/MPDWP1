...
author: "G1401211082_Windi Gunawan"
output:
  html_document:
    theme: yeti
    toc: true
...
```{r}
#mape data testing
mape.dlm <- MAPE(model.dlm$forecasts, test$Yt)
...
mape.ardl <- MAPE(model.ardl$forecasts, test$Yt) #data testing
...
points(test$Xt, model.dlm$forecasts,col="blue")
lines(test$Xt, model.dlm$forecasts,col="blue")
points(test$Xt, model.ardl$forecasts,col="green")
lines(test$Xt, model.ardl$forecasts,col="green")
