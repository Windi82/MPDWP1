...
Akan dicoba membangkitkan proses MA paling sederhana, yaitu MA(2) dengan $\theta_1 = 0.4$ dan $\theta_2 = 0.6$ sebanyak 300 observasi dan $c=0$. Karena diperlukan satu nilai awal untuk $e_{t}$, masukkan nilai pertama white noise sebagai nilai awal tersebut.
...
Akan dicoba membangkitkan proses AR paling sederhana, yaitu AR(2) dengan $\phi = 0.5$ dan $\phi = 0.2$ sebanyak 200 observasi dan $c=0$.
